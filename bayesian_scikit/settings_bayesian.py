...
### creation run.sh
with open(ROOT_DIR + '/bayesian_scikit/' + this_configuration_name + '/run_' + this_configuration_name + '.sh',
          'w') as outfile:
...
for type in types:
    with open(
                                                                    ROOT_DIR + '/bayesian_scikit/' + this_configuration_name + '/ensemble_' + type + '_' + this_configuration_name + '.sh',
                                                                    'w') as outfile:
        outfile.write("#!/usr/bin/env bash\n")
        outfile.write("source ../../py3env/bin/activate\n")
...
### creation run.sh
with open(ROOT_DIR + '/bayesian_scikit/' + this_configuration_name + '/print_params_' + this_configuration_name + '.sh',
          'w') as outfile:
    outfile.write("#!/usr/bin/env bash\n")
    outfile.write("source ../../py3env/bin/activate\n")
...
st = os.stat(
    ROOT_DIR + '/bayesian_scikit/' + this_configuration_name + '/print_params_' + this_configuration_name + '.sh')
...
with open(
                                                ROOT_DIR + '/bayesian_scikit/' + this_configuration_name + '/readable_settings_' + this_configuration_name + '.txt',
                                                'w') as outfile:
