...
filename = mode+'_npz/'+'cr_cf_al_ar_'+mode+'.npz'

eurm_k=750
configs_strange =[
    {'cat':2, 'alpha':1, 'beta':0, 'k':300, 'shrink':0,'threshold':0 },
    {'cat':3, 'alpha':1, 'beta':0, 'k':250, 'shrink':0,'threshold':0 },
    {'cat':4, 'alpha':1, 'beta':0, 'k':250, 'shrink':0,'threshold':0 },
    {'cat':5, 'alpha':1, 'beta':0, 'k':200, 'shrink':0,'threshold':0 },
    {'cat':6, 'alpha':1, 'beta':0, 'k':200, 'shrink':0,'threshold':0 },
    {'cat':7, 'alpha':1, 'beta':0, 'k':200, 'shrink':0,'threshold':0 },
    {'cat':8, 'alpha':1, 'beta':0, 'k':200, 'shrink':0,'threshold':0 },
