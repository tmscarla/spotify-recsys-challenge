...
mode = arg[0]
save = True
filename = mode+'_npz/'+'cf_ub_'+mode+'.npz'

if len(arg)>1: eurm_k= int(arg[1])
else: eurm_k = 750

configs_mix =[
    {'cat':2, 'alpha':1, 'beta':0.1, 'power':1.1, 'k':800, 'shrink':7,'threshold':0 },
    {'cat':3, 'alpha':1, 'beta':0.1, 'power':2.8, 'k':150, 'shrink':7,'threshold':0 },
    {'cat':4, 'alpha':1, 'beta':0.1, 'power':1.7, 'k':250, 'shrink':7,'threshold':0 },
    {'cat':5, 'alpha':1, 'beta':0.1, 'power':2.2, 'k':250, 'shrink':7,'threshold':0 },
    {'cat':6, 'alpha':1, 'beta':0.1, 'power':2.6, 'k':250, 'shrink':7,'threshold':0 },
    {'cat':8, 'alpha':1, 'beta':0.1, 'power':3.0, 'k':125, 'shrink':3,'threshold':0 },
    {'cat':10,'alpha':1, 'beta':0.1, 'power':2.7, 'k':100, 'shrink':3,'threshold':0 },
    ]

configs_pos_matrix =[
    {'cat':7, 'alpha':1, 'beta':0.1, 'power':1.2, 'k':450, 'shrink':7,'threshold':0 },
    {'cat':9, 'alpha':1, 'beta':0.1, 'power':1.7, 'k':200, 'shrink':3,'threshold':0 },
    ]
