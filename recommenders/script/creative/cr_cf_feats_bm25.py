...
filename = mode+'_npz/'+'cr_cf_feats_'+mode+'.npz'

eurm_k=750
configs_strange =[
    {'cat':2,'alpha':1, 'beta':0, 'k':1800, 'shrink':0,'threshold':0 },
    {'cat':3, 'alpha':1, 'beta':0, 'k':1800, 'shrink':0,'threshold':0 },
    {'cat':4,'alpha':1, 'beta':0, 'k':1800, 'shrink':0,'threshold':0 },
    {'cat':5, 'alpha':1, 'beta':0, 'k':1800, 'shrink':0,'threshold':0 },
    {'cat':6,'alpha':1, 'beta':0, 'k':1800, 'shrink':0,'threshold':0 },
    {'cat':7, 'alpha':1, 'beta':0, 'k':1800, 'shrink':0,'threshold':0 },
    {'cat':9,'alpha':1, 'beta':0, 'k':1800, 'shrink':0,'threshold':0 },
    {'cat':8, 'alpha':1, 'beta':0, 'k':1650, 'shrink':0,'threshold':0 },
    {'cat':10,'alpha':1, 'beta':0, 'k':160, 'shrink':0,'threshold':0 },
    ]
...
feats = ['acousticness_cluster','danceability_cluster','duration_ms_cluster','energy_cluster','instrumentalness_cluster',
     'liveness_cluster','loudness_cluster','speechiness_cluster','tempo_cluster','valence_cluster','popularity_cluster','key','mode','time_signature',
        'alid', 'arid']
for feat in feats:
