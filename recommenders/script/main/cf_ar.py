...
mode = arg[0]
save = True
filename = mode+'_npz/'+'cf_ar_'+mode+'.npz'
...
configs_mix =[
    ...
    {'cat':3, 'alpha':1, 'beta':0.1, 'power':2.8, 'k':200, 'shrink':0,'threshold':0 },
    ...
    {'cat':8, 'alpha':1, 'beta':0.1, 'power':3.0, 'k':200, 'shrink':0,'threshold':0 },
    {'cat':10,'alpha':1, 'beta':0.1, 'power':2.7, 'k':125, 'shrink':0,'threshold':0 },
    ]

configs_pos_matrix =[
    {'cat':7, 'alpha':1, 'beta':0.1, 'power':2.4, 'k':200, 'shrink':0,'threshold':0 },
    {'cat':9, 'alpha':1, 'beta':0.1, 'power':2.5, 'k':200, 'shrink':0,'threshold':0 },
    ]
...
rec = CF_AR_BM25(urm=urm, ucm=ucm, binary=False, bm25=True, datareader=dr, mode=mode, verbose=True, verbose_evaluation= False, similarity='tversky')
