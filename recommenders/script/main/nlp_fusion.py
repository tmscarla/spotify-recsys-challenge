...
if dr.online():
    sparse.save_npz(ROOT_DIR + '/recommenders/script/online_npz/nlp_fusion_online.npz', nlp_fusion)
else:
    sparse.save_npz(ROOT_DIR + '/recommenders/script/offline_npz/nlp_fusion_offline.npz', nlp_fusion)
