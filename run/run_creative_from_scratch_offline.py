...
if __name__ == '__main__':
    ...
    ar1_location = ROOT_DIR+'/recommenders/script/creative/offline_npz/npz_ar1/'
    ar2_location = ROOT_DIR+'/recommenders/script/creative/offline_npz/npz_ar2/'
    ar3_location = ROOT_DIR+'/recommenders/script/creative/offline_npz/npz_ar3/'
    ar4_location = ROOT_DIR+'/recommenders/script/creative/offline_npz/npz_ar4/'
    creative_location= ROOT_DIR+'/recommenders/script/creative/offline_npz/'
    ...
    file_names = {            'cb_ar':      "cb_ar_offline.npz",
                              ...
                              ###### creative things
                            'cr_cb_al_ar': 'cr_cb_al_ar_offline.npz',
                            'cr_cb_ar': 'cr_cb_ar_offline.npz',
                            'cr_cf_ar': 'cr_cf_ar_offline.npz',
                            'cr_cf_feats_cat10': 'cr_cf_feats_cat10_offline.npz',
                            'cr_cluster_creative': 'cr_cluster_creative_offline.npz'
    ...
    ev.evaluate(recommendation_list=eurm_to_recommendation_list(FINAL), name='creative_track_offline')
